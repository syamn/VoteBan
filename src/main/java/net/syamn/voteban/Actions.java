...
public class Actions {
	...
	private static final String logPrefix = VoteBan.logPrefix;
	private static final String msgPrefix = VoteBan.msgPrefix;

	private final VoteBan plugin;

	public Actions(VoteBan plugin){
		this.plugin = plugin;
	}
	...
	public static void message(CommandSender sender, Player player, String message){
		if (message != null){
			message = message
					...
					.replaceAll("%version", VoteBan.getInstance().getDescription().getVersion());
			if (player != null){
